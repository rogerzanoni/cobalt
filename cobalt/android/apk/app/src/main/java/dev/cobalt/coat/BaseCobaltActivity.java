...
public abstract class BaseCobaltActivity extends Activity {
  ...
  protected boolean mIsCobaltUsingAndroidOverlay;
  ...
  /**
   * Instantiates the StarboardBridge. Apps may subclass StarboardBridge if they
  ...
  protected void createNewSurfaceView() {
    if (mIsCobaltUsingAndroidOverlay) {
      return;
    }
