...
logging::LogMessage* CheckOpResult::CreateLogMessage(const char* file,
                                                     int line,
                                                     const char* expr_str,
                                                     char* v1_str,
                                                     char* v2_str) {
  logging::LogMessage* const log_message =
      new logging::LogMessage(file, line, logging::SB_LOG_FATAL);
